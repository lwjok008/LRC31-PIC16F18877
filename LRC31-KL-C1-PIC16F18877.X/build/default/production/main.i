...
# 62 "main.c"
unsigned char motor_do_time;
unsigned int ad_value_I_TEST;
unsigned int ad_value[20]={0},sum_value;
unsigned int test_time,motor_run_1s;
bit FLAG_OVER_TIME_30S,FLAG_OVER_CURRENT,flag_overload_out,flag_overload_in,flag_overload_in_ES,flag_overload_out_ES;
unsigned int overload_time_out,overload_time_in,overload_time_out_ES,overload_time_in_ES;
void delayus(unsigned char x);
void delay(unsigned int x);
unsigned char i_avg;
unsigned int ad_value_I_TEST_avg;
unsigned char time_2ms_12=0,time_2ms_13=0;
void main(void)
{
delay(1);
sum_value=0;
