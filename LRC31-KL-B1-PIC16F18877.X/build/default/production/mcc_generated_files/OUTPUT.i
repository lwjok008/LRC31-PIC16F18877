...
# 1 "mcc_generated_files/OUTPUT.c"
...
# 2 "mcc_generated_files/OUTPUT.c"
bit FLAG_ALARM=0,FLAG_ALARM_OVER1=0,FLAG_ALARM_OVER2=0;
unsigned char out_order=1,out_stop_order=1,in_order=1,in_stop_order=1,ES_in_stop_order=1,ES_in_order=1,ES_out_stop_order=1,ES_out_order=1;
unsigned int I_current=0;
unsigned int led_time_40ms;
...
else if((!FLAG_ALARM_CMD)&&(!FLAG_ALARM_CMD1)&&(!FLAG_ALARM_CMD2)&&(!FLAG_ALARM_RUN)&&(!FLAG_OVER_TIME_30S)&&(!FLAG_OVER_CURRENT)&&(!FLAG_ALARM_OVER1)&&(!FLAG_ALARM_OVER2))
{
LATDbits.LATD0=1;
}
}
...
else if(FLAG_ALARM_OVER2)
{
LATEbits.LATE2 = 1;
}
else if((FLAG_ALARM_CMD) || (FLAG_ALARM_CMD1)|| (FLAG_ALARM_CMD2)||(FLAG_ALARM_RUN))
{
led_time_40ms++;
if(led_time_40ms>=3)
{
