...
/////////////////////////////////////////////////////////////////
    disp_ASCII_8x16(16,2,9,red,black);	 
...
//    disp_ASCII_8x16(16*9,2,0,red,black);	
    ...
    disp_16x16(16*2,32,dian4,yellow,black);  //  
    disp_16x16(16*3,32,liu,yellow,black);  //   
...
{
    disp_ASCII_8x16(16*6,32,bai,black,black);
    disp_ASCII_8x16(16*6+8,32,shi,white,black);
}
    disp_ASCII_8x16(16*7,32,38,yellow,black);
    disp_ASCII_8x16(16*7+8,32,ge,white,black);
	    
    disp_16x16(16*8,32,A,yellow,black);  //  
...
{
    disp_ASCII_8x16(16*6,64,bai,black,black);
    disp_ASCII_8x16(16*6+8,64,shi,white,black);
}
    disp_ASCII_8x16(16*7,64,38,green,black);
    disp_ASCII_8x16(16*7+8,64,ge,white,black);	   
    disp_16x16(16*8,64,A,green,black);  // 
...
{
    disp_ASCII_8x16(16*6,96,bai,black,black);
    disp_ASCII_8x16(16*6+8,96,shi,white,black);
}
    disp_ASCII_8x16(16*7,96,38,red,black);
    disp_ASCII_8x16(16*7+8,96,ge,white,black);	    
    disp_16x16(16*8,96,A,red,black);  //   
}
